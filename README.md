Machine Learning based Scheduler Predictor that uses Random Forest to predict the optimal scheduling algorithm based on process characteristics such as:
•	Arrival time
•	Burst time
•	Priority
